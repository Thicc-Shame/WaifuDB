...
function login() {
  var username = (document.getElementById("u") as HTMLInputElement).value;
  var password = (document.getElementById("p") as HTMLInputElement).value;
...
function submit() {
      var p0 = (document.getElementById("p") as HTMLInputElement).value;
      var p1 = (document.getElementById("c") as HTMLInputElement).value;
      if(p0 == p1) {
        var username = (document.getElementById("u") as HTMLInputElement).value;
        var password = (document.getElementById("p") as HTMLInputElement).value;
        console.log(username);
